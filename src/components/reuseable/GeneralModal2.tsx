...
const GeneralModal2: React.FC<GeneralModalProps2> = ({ handleClose, content, heading,close }) => {
    return (
        ...
        >
            ...
            >
                <div
                    className={`modal-content z-[2000] bg-[#252731] lg:w-[44%]  py-6 px-12 shadow-md w-full rounded-3xl overflow-y-auto transform transition-transform duration-300 ease-in-out bounce`}
                >
